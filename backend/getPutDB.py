...
CONNECTION_URI = "postgres://chat_sql_db_user:i5QNFqt3VJy0y5PQEBsRc35GvbejWymi@dpg-cjtf2a15mpss73d3rv1g-a.oregon-postgres.render.com/chat_sql_db"
...
def loginUser(email, password):
    ...
    if not user :
        return {'error': 'No such user exist'}, 404
