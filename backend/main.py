...
def create_user():
    ...
    if res['exist']:
        data = {"uuid":res['uuid'], "message": "Chatbot created successfully"}
    else:
        data = {"uuid": uniqueid, "message": "Chatbot created successfully"}
...
def set_key():
    ...
    if res:
        data = {"message": "Saved openai key successfully"}
        return jsonify(data), 200
